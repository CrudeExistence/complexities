...
function findFourth2(numbers) {
  if (numbers[3]) {
    ...
    return console.log('Array is too short')
  }
}

//This would run faster but it wouldn't have a faster time complexity
...
// ANSWER:  Each of them has 3 obj/arr and there is only one that would be a random or possible length difference which could change the length of it. 2 of them are a set amount that wouldn't change.
